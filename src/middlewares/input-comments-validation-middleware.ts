...
export const likeStatusTypeValidation = [
    body('likeStatus').trim().exists({checkFalsy: true}).withMessage('The field [likeStatus] must exist')
        .bail().isIn(['None', 'Like', 'Dislike']).withMessage('likeStatus has incorrect values'),
]
